...
<body>
	<nav>
		<ul>
			...
			<li><a href="monthlyData.php">Monthly Report</a></li>
		</ul>
		<div class="logo">
					...
					<tbody>
						...
						?>
								...
								<tr>
									...
									<td><button class="btn2"><a href="delete.php?id=<?php echo $res['Report ID']; ?>" >Solved <i class="fa fa-trash" aria-hidden="true"></i> </a></button></td>
